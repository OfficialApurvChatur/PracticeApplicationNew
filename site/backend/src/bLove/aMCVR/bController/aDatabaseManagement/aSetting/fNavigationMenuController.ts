...
const navigationMenuController = (Model=NavigationMenuModel, Label="NavigationMenuModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.navigationMenuModel.list({ 
          Label
        }), 
        data: list 
      });
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.navigationMenuModel.create({ 
          Label  
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: create,
        eventList: eventVariable.navigationMenuModel.create({
          Label, 
        }),
        request
      });
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.navigationMenuModel.create({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.navigationMenuModel.create({
          Label, 
          request 
        }),
        request
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.navigationMenuModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.navigationMenuModel.update({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.navigationMenuModel.update({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.navigationMenuModel.update({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.navigationMenuModel.update({
          Label, 
          request 
        }),
        request
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.navigationMenuModel.delete({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.navigationMenuModel.delete({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.navigationMenuModel.delete({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.navigationMenuModel.delete({
          Label, 
          request 
        }),
        request
