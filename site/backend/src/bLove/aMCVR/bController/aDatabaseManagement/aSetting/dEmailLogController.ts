...
const emailLogController = (Model=EmailLogModel, Label="EmailLogModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.emailLogModel.list({ 
          Label
        }), 
        data: list 
      });
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.emailLogModel.create({ 
          Label  
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: create,
        eventList: eventVariable.emailLogModel.create({
          Label, 
        }),
        request
      });
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.emailLogModel.create({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.emailLogModel.create({
          Label, 
          request 
        }),
        request
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.emailLogModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.emailLogModel.update({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.emailLogModel.update({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.emailLogModel.update({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.emailLogModel.update({
          Label, 
          request 
        }),
        request
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.emailLogModel.delete({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.emailLogModel.delete({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.emailLogModel.delete({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.emailLogModel.delete({
          Label, 
          request 
        }),
        request
