...
const automationController = (Model=AutomationModel, Label="AutomationModel") => ({
  // List Controller
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.automationModel.list({ 
          Label
        }), 
        data: list 
      });
  ...
  create: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.automationModel.create({ 
          Label  
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: create,
        eventList: eventVariable.automationModel.create({
          Label, 
        }),
        request
      });
      ...
      emailToCompanyMiddleware({
        Label,
        data: create,
        textMessage: emailToCompanyVariable.automationModel.create({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: create,
        textMessage: emailToUserVariable.automationModel.create({
          Label, 
          request 
        }),
        request
  ...
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Create Cache
      cacheCreateMiddleware({ 
        key: cacheVariable.automationModel.retrieve({ 
          Label, 
          request 
        }), 
        data: retrieve 
  ...
  update: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.automationModel.update({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: update,
        eventList: eventVariable.automationModel.update({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: update,
        textMessage: emailToCompanyVariable.automationModel.update({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: update,
        textMessage: emailToUserVariable.automationModel.update({
          Label, 
          request 
        }),
        request
  ...
  delete: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      // Delete Cache
      cacheDeleteMiddleware({ 
        keyList: cacheVariable.automationModel.delete({ 
          Label, 
          request 
        }), 
      });
      ...
      eventCreateMiddleware({
        Label,
        data: delete_object,
        eventList: eventVariable.automationModel.delete({
          Label, 
          request 
        }),
        request
      ...
      emailToCompanyMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToCompanyVariable.automationModel.delete({
          Label, 
          request 
        }),
      });
      ...
      emailToUserMiddleware({
        Label,
        data: delete_object,
        textMessage: emailToUserVariable.automationModel.delete({
          Label, 
          request 
        }),
        request
