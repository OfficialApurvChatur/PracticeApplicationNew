...
export type AutomationModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AutomationModelType>({
...
export const AutomationModel = mongoose.model<AutomationModelType>("AutomationModel", schema);
