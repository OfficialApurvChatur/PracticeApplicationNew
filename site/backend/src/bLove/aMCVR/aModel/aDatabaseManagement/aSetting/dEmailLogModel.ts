...
export type EmailLogModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<EmailLogModelType>({
...
export const EmailLogModel = mongoose.model<EmailLogModelType>("EmailLogModel", schema);
