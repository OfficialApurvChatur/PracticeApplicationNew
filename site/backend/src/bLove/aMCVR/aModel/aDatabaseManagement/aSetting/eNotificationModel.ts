...
export type NotificationModelType = DefaultSchemaUtilityType & {
...
export const NotificationModel = mongoose.model<NotificationModelType>("NotificationModel", schema);
