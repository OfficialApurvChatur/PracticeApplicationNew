...
export type NavigationMenuModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<NavigationMenuModelType>({
...
export const NavigationMenuModel = mongoose.model<NavigationMenuModelType>("NavigationMenuModel", schema);
