...
const apiLogService = {
  ...
  async create({ handler, create, Label, request }: CreateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: create,
      textMessageToCompany: emailToCompanyVariable.apiLogModel.create({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.apiLogModel.create({
        Label, 
        request 
      }),
      request
  ...
  async update({ handler, update, Label, request }: UpdateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: update,
      textMessageToCompany: emailToCompanyVariable.apiLogModel.update({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.apiLogModel.update({
        Label, 
        request 
      }),
      request
  ...
  async delete({ handler, delete_object, Label, request }: DeleteType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: delete_object,
      textMessageToCompany: emailToCompanyVariable.apiLogModel.delete({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.apiLogModel.delete({
        Label, 
        request 
      }),
      request
