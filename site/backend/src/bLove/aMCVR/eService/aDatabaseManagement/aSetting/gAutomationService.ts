...
const automationService = {
  ...
  async create({ handler, create, Label, request }: CreateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: create,
      textMessageToCompany: emailToCompanyVariable.automationModel.create({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.automationModel.create({
        Label, 
        request 
      }),
      request
  ...
  async update({ handler, update, Label, request }: UpdateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: update,
      textMessageToCompany: emailToCompanyVariable.automationModel.update({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.automationModel.update({
        Label, 
        request 
      }),
      request
  ...
  async delete({ handler, delete_object, Label, request }: DeleteType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: delete_object,
      textMessageToCompany: emailToCompanyVariable.automationModel.delete({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.automationModel.delete({
        Label, 
        request 
      }),
      request
