...
const activityLogService = {
  ...
  async create({ handler, create, Label, request }: CreateType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.activityLogModel.create({ 
        Label  
      })
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: create,
      eventList: eventVariable.activityLogModel.create({
        Label, 
      }),
      request
    });
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: create,
      textMessageToCompany: emailToCompanyVariable.activityLogModel.create({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.activityLogModel.create({
        Label, 
        request 
      }),
      request
  ...
  async update({ handler, update, Label, request }: UpdateType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.activityLogModel.update({ 
        Label, 
        request 
      })
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: update,
      eventList: eventVariable.activityLogModel.update({
        Label, 
        request 
      }),
      request
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: update,
      textMessageToCompany: emailToCompanyVariable.activityLogModel.update({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.activityLogModel.update({
        Label, 
        request 
      }),
      request
  ...
  async delete({ handler, delete_object, Label, request }: DeleteType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.activityLogModel.delete({ 
        Label, 
        request 
      }), 
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: delete_object,
      eventList: eventVariable.activityLogModel.delete({
        Label, 
        request 
      }),
      request
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: delete_object,
      textMessageToCompany: emailToCompanyVariable.activityLogModel.delete({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.activityLogModel.delete({
        Label, 
        request 
      }),
      request
