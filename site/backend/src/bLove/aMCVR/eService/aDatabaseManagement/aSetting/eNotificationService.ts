...
const notificationService = {
  ...
  async create({ handler, create, Label, request }: CreateType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.notificationModel.create({ 
        Label  
      })
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: create,
      eventList: eventVariable.notificationModel.create({
        Label, 
      }),
      request
    });
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: create,
      textMessageToCompany: emailToCompanyVariable.notificationModel.create({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.notificationModel.create({
        Label, 
        request 
      }),
      request
  ...
  async update({ handler, update, Label, request }: UpdateType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.notificationModel.update({ 
        Label, 
        request 
      })
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: update,
      eventList: eventVariable.notificationModel.update({
        Label, 
        request 
      }),
      request
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: update,
      textMessageToCompany: emailToCompanyVariable.notificationModel.update({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.notificationModel.update({
        Label, 
        request 
      }),
      request
  ...
  async delete({ handler, delete_object, Label, request }: DeleteType) {
    ...
    await queueUtility.cacheQueue.add("delete", {
      keyList: cacheVariable.notificationModel.delete({ 
        Label, 
        request 
      }), 
    });
    ...
    await queueUtility.eventQueue.add("create", {
      Label,
      data: delete_object,
      eventList: eventVariable.notificationModel.delete({
        Label, 
        request 
      }),
      request
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: delete_object,
      textMessageToCompany: emailToCompanyVariable.notificationModel.delete({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.notificationModel.delete({
        Label, 
        request 
      }),
      request
