...
const navigationMenuService = {
  ...
  async create({ handler, create, Label, request }: CreateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: create,
      textMessageToCompany: emailToCompanyVariable.navigationMenuModel.create({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.navigationMenuModel.create({
        Label, 
        request 
      }),
      request
  ...
  async update({ handler, update, Label, request }: UpdateType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: update,
      textMessageToCompany: emailToCompanyVariable.navigationMenuModel.update({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.navigationMenuModel.update({
        Label, 
        request 
      }),
      request
  ...
  async delete({ handler, delete_object, Label, request }: DeleteType) {
    ...
    await queueUtility.emailQueue.add("both", {
      Label,
      data: delete_object,
      textMessageToCompany: emailToCompanyVariable.navigationMenuModel.delete({
        Label, 
        request 
      }),
      textMessageToUser: emailToUserVariable.navigationMenuModel.delete({
        Label, 
        request 
      }),
      request
