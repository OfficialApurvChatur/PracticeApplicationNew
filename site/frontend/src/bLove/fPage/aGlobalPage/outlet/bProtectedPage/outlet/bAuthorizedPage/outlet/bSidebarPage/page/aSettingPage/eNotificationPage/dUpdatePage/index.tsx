...
import NotificationUpdateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/aSettingComponent/eNotificationComponent/dUpdateComponent";
...
const NotificationUpdatePage = () => {
  ...
  const [ updateAPITrigger, updateAPIResponse ] = notificationAPIEndpoint.useNotificationUpdateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.notification, "Update") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
